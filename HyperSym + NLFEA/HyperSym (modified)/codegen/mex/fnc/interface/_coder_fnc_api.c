 ...
 * _coder_fnc_api.c
 *
 * Code generation for function '_coder_fnc_api'
 *
 */
...
void fnc_api(const mxArray *const prhs[2], int32_T nlhs, const mxArray *plhs[2])
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  Svol = (real_T(*)[6])mxMalloc(sizeof(real_T[6]));
  Dvol = (real_T(*)[36])mxMalloc(sizeof(real_T[36]));
  /* Marshall function inputs */
  in1 = emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "in1");
  in2 = c_emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "in2");
  /* Invoke the target function */
  fnc(&st, *in1, *in2, *Svol, *Dvol);
  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*Svol);
  if (nlhs > 1) {
    plhs[1] = b_emlrt_marshallOut(*Dvol);
  }
}

/* End of code generation (_coder_fnc_api.c) */
